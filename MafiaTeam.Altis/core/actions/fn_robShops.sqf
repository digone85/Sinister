...
_pos = GetPos _shop;
if(playersNumber west < 2) exitWith { hint "Não há 2 policias online para roubar este estabelecimento!"};
...
if(_shop getVariable ["coolDown",false]) exitWith {hint "Você só pode roubar este estabelecimento novamente depois de 15 minutos!"};
